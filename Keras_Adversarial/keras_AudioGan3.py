...
discriminator.add(Convolution1D(4, 256, subsample_length = 4, input_shape=(32768,1), activation='LeakyReLU'))
discriminator.add(Dropout(0.5))
discriminator.add(Convolution1D(16, 256, input_dim=4, subsample_length = 16, activation='LeakyReLU'))
discriminator.add(Dropout(0.5))
...
generator.add(Convolution1D(16, 64, activation='LeakyReLU', input_shape=(2048,16),border_mode='same'))
generator.add(BatchNormalization())
generator.add(UpSampling1D(4))
generator.add(Convolution1D(64, 256, activation='LeakyReLU',border_mode='same'))
generator.add(BatchNormalization())
generator.add(UpSampling1D(4))
